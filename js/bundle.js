...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from build.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsBuildHtml.
     * @public
     */

    goog.module('docsBuildHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      var param155 = function param155() {
        ...
        ie_close('h2');
        ie_open('p');
        itext('Lorem ipsum dolor sit ');
        ie_open('a', null, null, 'href', 'https://www.google.com');
        itext('amet');
        ie_close('a');
        itext(', consectetur ');
        ie_open('code');
        itext('adipiscing');
        ie_close('code');
        itext(' elit. Curabitur nulla libero, eleifend in euismod eget, fringilla id diam. Proin quis interdum ipsum. Fusce eros metus, ');
        ie_open('code');
        itext('hendrerit ut egestas nec');
        ie_close('code');
        itext(', sagittis id velit.');
        ie_close('p');
        ie_open('p');
        ...
        itext('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur nulla libero, eleifend in euismod eget, fringilla id diam. Proin quis interdum ipsum. Fusce eros metus, hendrerit ut egestas nec, sagittis id velit.');
        ie_close('p');
        $templateAlias2({ code: 'console.log(\'Hello, World!\');', mode: 'javascript' }, null, opt_ijData);
        ie_open('p');
        itext('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur nulla libero, eleifend in euismod eget, fringilla id diam. Proin quis interdum ipsum. Fusce eros metus, hendrerit ut egestas nec, sagittis id velit.');
        ie_close('p');
        ie_close('article');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsBuildHtml.render';
    }
  ...
  var docsBuildHtml = function (_Component) {
    babelHelpers.inherits(docsBuildHtml, _Component);

    function docsBuildHtml() {
      babelHelpers.classCallCheck(this, docsBuildHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsBuildHtml.__proto__ || Object.getPrototypeOf(docsBuildHtml)).apply(this, arguments));
    }

    return docsBuildHtml;
  }(Component);

  Soy.register(docsBuildHtml, templates);
  this['metalNamed']['build'] = this['metalNamed']['build'] || {};
  this['metalNamed']['build']['docsBuildHtml'] = docsBuildHtml;
  this['metalNamed']['build']['templates'] = templates;
  this['metal']['build'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace docsCreateHtml.
     * @public
     */

    goog.module('docsCreateHtml.incrementaldom');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsCreateHtml.render';
    }
  ...
  var docsCreateHtml = function (_Component) {
    babelHelpers.inherits(docsCreateHtml, _Component);

    function docsCreateHtml() {
      babelHelpers.classCallCheck(this, docsCreateHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsCreateHtml.__proto__ || Object.getPrototypeOf(docsCreateHtml)).apply(this, arguments));
    }

    return docsCreateHtml;
  }(Component);

  Soy.register(docsCreateHtml, templates);
  this['metalNamed']['create'] = this['metalNamed']['create'] || {};
  this['metalNamed']['create']['docsCreateHtml'] = docsCreateHtml;
  this['metalNamed']['create']['templates'] = templates;
  this['metal']['create'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace docsDeployHtml.
     * @public
     */

    goog.module('docsDeployHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias1(soy.$$assignDefaults({ content: param175 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsDeployHtml.render';
    }
  ...
  var docsDeployHtml = function (_Component) {
    babelHelpers.inherits(docsDeployHtml, _Component);

    function docsDeployHtml() {
      babelHelpers.classCallCheck(this, docsDeployHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsDeployHtml.__proto__ || Object.getPrototypeOf(docsDeployHtml)).apply(this, arguments));
    }

    return docsDeployHtml;
  }(Component);

  Soy.register(docsDeployHtml, templates);
  this['metalNamed']['deploy'] = this['metalNamed']['deploy'] || {};
  this['metalNamed']['deploy']['docsDeployHtml'] = docsDeployHtml;
  this['metalNamed']['deploy']['templates'] = templates;
  this['metal']['deploy'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  var docsDevelopHtml = function (_Component) {
    babelHelpers.inherits(docsDevelopHtml, _Component);

    function docsDevelopHtml() {
      babelHelpers.classCallCheck(this, docsDevelopHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsDevelopHtml.__proto__ || Object.getPrototypeOf(docsDevelopHtml)).apply(this, arguments));
    }

    return docsDevelopHtml;
  }(Component);

  Soy.register(docsDevelopHtml, templates);
  this['metalNamed']['develop'] = this['metalNamed']['develop'] || {};
  this['metalNamed']['develop']['docsDevelopHtml'] = docsDevelopHtml;
  this['metalNamed']['develop']['templates'] = templates;
  this['metal']['develop'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['build'];
  ...
  this['metal']['docsBuildHtml'] = docsBuildHtml;
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['create'];
  ...
  this['metal']['docsCreateHtml'] = docsCreateHtml;
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['deploy'];
  ...
  this['metal']['docsDeployHtml'] = docsDeployHtml;
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['develop'];
  ...
  this['metal']['docsDevelopHtml'] = docsDevelopHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param196 = function param196() {
        $templateAlias2({ section: opt_data.site.index.children[1] }, null, opt_ijData);
        $topics(opt_data, null, opt_ijData);
      };
      $templateAlias1(soy.$$assignDefaults({ elementClasses: 'docs', content: param196 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
    ...
    function $topics(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('div', null, null, 'class', 'row');
      ie_open('div', null, null, 'class', 'container-hybrid');
      $templateAlias3({ action: '/docs', placeholder: 'Search Docs' }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
      ie_close('div');
      ...
      ie_open('div', null, null, 'class', 'row');
      var topicList218 = opt_data.site.index.children[1].children;
      var topicListLen218 = topicList218.length;
      for (var topicIndex218 = 0; topicIndex218 < topicListLen218; topicIndex218++) {
        var topicData218 = topicList218[topicIndex218];
        if (!topicData218.hidden) {
          ie_open('div', null, null, 'class', 'col-md-6 col-xs-16');
          ie_open('a', null, null, 'class', 'topic radial-out', 'href', topicData218.url);
          ie_open('div', null, null, 'class', 'topic-icon');
          ie_void('span', null, null, 'class', 'icon-16-' + topicData218.icon);
          ie_close('div');
          ie_open('h3', null, null, 'class', 'topic-title');
          var dyn16 = topicData218.title;
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      var param223 = function param223() {
        ...
        $sidebar(opt_data, null, opt_ijData);
    ...
    if (goog.DEBUG) {
      $tutorials.soyTemplateName = 'pageTutorials.tutorials';
    }
     ...
     * @suppress {checkTypes}
     */
    function $card(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'content');
      ie_open('section');
      ie_open('h3');
      ...
      itext('codelab');
      ie_close('a');
      itext(', you\'ll learn how to build Accelerated Mobile Pages -- or AMP for short. To achieve this you will implement a simple news article web page that conforms to the AMP specifications while incorporating several typical web features commonly used on mobile news sites.');
      ie_close('p');
      ie_open('h4');
      itext('What you\'ll learn');
      ie_close('h4');
      ie_open('ul', null, null, 'class', 'checklist');
      ie_open('li');
      itext('How AMP improves the user experience of the mobile web.');
      ie_close('li');
      ie_open('li');
      itext('The foundations of an AMP site.');
      ie_close('li');
      ie_open('li');
      itext('AMP\'s limitations.');
      ie_close('li');
      ie_open('li');
      itext('How AMP\'s web components solve common news site problems.');
      ie_close('li');
      ie_open('li');
      itext('How to validate your AMP.');
      ie_close('li');
      ie_open('li');
      itext('How to prepare your AMP for Google Search.');
      ie_close('li');
      ie_close('ul');
      ie_open('h4');
      ...
      ie_open('ul');
      ie_open('li');
      itext('The sample code');
      ie_close('li');
      ie_open('li');
      ie_open('code');
      itext('Python');
      ie_close('code');
      itext(' (preferably 2.7) or the Chrome 200 OK Web Server extension');
      ie_close('li');
      ie_open('li');
      itext('Chrome (or an equivalent browser that can inspect the JavaScript console)');
      ie_close('li');
      ie_open('li');
      itext('Code Editor (for example Atom, Sublime, Notepad++)');
      ie_close('li');
      ie_close('ul');
      ie_open('h4');
      itext('How will you use this tutorial?');
      ie_close('h4');
      ie_open('ul', null, null, 'class', 'radio-group');
      ie_open('li');
      ie_open('input', null, null, 'type', 'radio', 'id', 'answ_1-0', 'name', 'poll_1', 'value', 'answ_1-0');
      ie_close('input');
      ie_open('label', null, null, 'for', 'answ_1-0');
      itext('Read it through only');
      ie_close('label');
      ie_close('li');
      ie_open('li');
      ie_open('input', null, null, 'type', 'radio', 'id', 'answ_1-1', 'name', 'poll_1', 'value', 'answ_1-1');
      ie_close('input');
      ie_open('label', null, null, 'for', 'answ_1-1');
      itext('Read it and complete the exercises');
      ie_close('label');
      ie_close('li');
      ie_close('ul');
      ie_open('div', null, null, 'class', 'aside');
      ie_open('p');
      itext('Spreadsheets? What does this have to do with getting off the main thread, avoiding janky UIs and performance?');
      ie_close('p');
      ie_open('p');
      itext('Going reactive makes you define your workflow in a way that is trivial to move to another ');
      ie_open('code');
      itext('thread');
      ie_close('code');
      itext(', share work between a pool of threads, and manage error conditions. Agera comes with a mechanism to yield to the UI as much as possible, which avoids dropped frames, janky scrolls and unresponsive UIs.');
      ie_close('p');
      ie_open('h4');
      itext('How will you use this tutorial?');
      ie_close('h4');
      ie_open('ul', null, null, 'class', 'radio-group');
      ie_open('li');
      ie_open('input', null, null, 'type', 'radio', 'id', 'answ_2-0', 'name', 'poll_2', 'value', 'answ_2-0');
      ie_close('input');
      ie_open('label', null, null, 'for', 'answ_2-0');
      itext('Read it through only');
      ie_close('label');
      ie_close('li');
      ie_open('li');
      ie_open('input', null, null, 'type', 'radio', 'id', 'answ_2-1', 'name', 'poll_2', 'value', 'answ_2-1');
      ie_close('input');
      ie_open('label', null, null, 'for', 'answ_2-1');
      itext('Read it and complete the exercises');
      ie_close('label');
      ie_close('li');
      ie_close('ul');
      ie_close('div');
      ie_open('div', null, null, 'class', 'aside aside--danger');
      ie_open('p');
      itext('Spreadsheets? What does this have to do with getting off the main thread, avoiding janky UIs and performance?');
      ie_close('p');
      ie_open('p');
      itext('Going reactive makes you define your workflow in a way that is trivial to move to another thread, share work between a pool of threads, and manage error conditions. Agera comes with a mechanism to yield to the UI as much as possible, which avoids dropped frames, janky scrolls and unresponsive UIs.');
      ie_close('p');
      ie_close('div');
      ie_open('div', null, null, 'class', 'aside aside--warning');
      ie_open('p');
      itext('Spreadsheets? What does this have to do with getting off the main thread, avoiding janky UIs and performance?');
      ie_close('p');
      ie_open('p');
      ...
      ie_close('p');
      ie_close('div');
      ie_open('table', null, null, 'class', 'table block');
      ie_open('thead');
      ie_open('tr');
      ie_open('th');
      itext('Tables');
      ie_close('th');
      ie_open('th', null, null, 'align', 'center');
      itext('Are');
      ie_close('th');
      ie_open('th', null, null, 'align', 'right');
      itext('Cool');
      ie_close('th');
      ie_close('tr');
      ie_close('thead');
      ...
      itext('col 3 is');
      ie_close('td');
      ie_open('td', null, null, 'align', 'center');
      itext('right-aligned');
      ie_close('td');
      ie_open('td', null, null, 'align', 'right');
      itext('$1600');
      ie_close('td');
      ie_close('tr');
      ie_open('tr');
      ...
      ie_close('table');
      ie_open('figure');
      ie_open('img', null, null, 'src', 'https://cloud.githubusercontent.com/assets/19154228/21943110/ac49497a-d984-11e6-9b1c-5a63b0a9e493.png', 'alt', '');
      ie_close('img');
      ie_close('figure');
      ie_open('figure');
      ie_open('img', null, null, 'src', 'https://cloud.githubusercontent.com/assets/19154228/21943077/91d70424-d984-11e6-97ec-b65924d30926.png', 'srcset', 'https://cloud.githubusercontent.com/assets/19154228/21943077/91d70424-d984-11e6-97ec-b65924d30926.png 1x, https://cloud.githubusercontent.com/assets/19154228/21943110/ac49497a-d984-11e6-9b1c-5a63b0a9e493.png 2x', 'alt', '');
      ie_close('img');
      ie_close('figure');
      ie_open('div', null, null, 'class', 'text-center');
      ie_open('button', null, null, 'class', 'btn btn-inverse-accent');
      itext('Report a problem');
      ie_close('button');
      ie_open('button', null, null, 'class', 'btn btn-accent');
      itext('I have installed WeDeploy CLI');
      ie_close('button');
      ie_close('div');
      ie_close('section');
      ie_close('div');
    ...
    exports.card = $card;
    if (goog.DEBUG) {
      $card.soyTemplateName = 'pageTutorials.card';
    }
    ...
    function $sidebar(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_close('a');
      ie_open('div', null, null, 'class', 'sidebar-toggler-content toggler-collapsed');
      ie_open('ul', null, null, 'class', 'sidebar-list toggler-collapsed');
      ie_open('li', null, null, 'class', 'sidebar-item sidebar-link-read');
      ie_open('a', null, null, 'class', 'sidebar-link', 'href', 'step-1');
      ...
      ie_close('a');
      ie_close('li');
      ie_open('li', null, null, 'class', 'sidebar-item sidebar-link-selected');
      ie_open('a', null, null, 'class', 'sidebar-link', 'href', 'step-2');
      ie_open('span', null, null, 'class', 'tutorial-step');
      itext('2');
      ie_close('span');
      ie_open('span');
      itext('Get the sample code');
      ie_close('span');
      ie_close('a');
      ie_close('li');
      ie_open('li', null, null, 'class', 'sidebar-item');
      ie_open('a', null, null, 'class', 'sidebar-link', 'href', 'step-3');
      ie_open('span', null, null, 'class', 'tutorial-step');
      itext('3');
      ie_close('span');
      ie_open('span');
      itext('Canonical URLs, Meta Data & Search');
      ie_close('span');
      ie_close('a');
      ie_close('li');
      ie_open('li', null, null, 'class', 'sidebar-item');
      ie_open('a', null, null, 'class', 'sidebar-link', 'href', 'step-4');
      ie_open('span', null, null, 'class', 'tutorial-step');
      itext('4');
      ie_close('span');
      ie_open('span');
      itext('Congratulations!');
      ie_close('span');
      ie_close('a');
      ie_close('li');
      ie_close('ul');
    ...
    if (goog.DEBUG) {
      $sidebar.soyTemplateName = 'pageTutorials.sidebar';
    }
    ...
    function $topbar(opt_data, opt_ignored, opt_ijData) {
      ...
      $left(opt_data, null, opt_ijData);
      $right(opt_data, null, opt_ijData);
      ie_close('nav');
    }
    exports.topbar = $topbar;
    if (goog.DEBUG) {
      $topbar.soyTemplateName = 'pageTutorials.topbar';
    }
     ...
     * @suppress {checkTypes}
     */
    function $left(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'topbar-logo');
      ie_open('a', null, null, 'class', 'topbar-logo-link', 'href', '/');
      ie_open('span', null, null, 'class', 'name');
      itext('Tutorial Name');
    ...
    exports.left = $left;
    if (goog.DEBUG) {
      $left.soyTemplateName = 'pageTutorials.left';
    }
     ...
     * @suppress {checkTypes}
     */
    function $right(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'time-remaining');
      ie_void('span', null, null, 'class', 'icon icon-16-clock');
      ie_open('span', null, null, 'class', 'name');
      itext('38 min remaining');
      ie_close('span');
      ie_close('div');
    }
    exports.right = $right;
    if (goog.DEBUG) {
      $right.soyTemplateName = 'pageTutorials.right';
    }

    exports.render.params = [];
    exports.render.types = {};
    exports.tutorials.params = [];
    exports.tutorials.types = {};
    exports.card.params = [];
    exports.card.types = {};
    exports.sidebar.params = [];
    exports.sidebar.types = {};
    exports.topbar.params = [];
    exports.topbar.types = {};
    exports.left.params = [];
    exports.left.types = {};
    exports.right.params = [];
    exports.right.types = {};
    templates = exports;
    return exports;
  });
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param250 = function param250() {
        ie_open('div');
        ie_open('header', null, null, 'class', 'header');
        ie_open('div', null, null, 'class', 'container');
        ie_open('h1', null, null, 'class', 'header-title');
